...
# Menghitung nilai akhir semua mahasiswa dalam data_mahasiswa
...
def main():
    data_mahasiswa = {
        "Mahasiswa 1": (70, 90),  # Contoh data nilai mahasiswa 1
        "Mahasiswa 2": (72, 89),  # Contoh data nilai mahasiswa 2
    }
